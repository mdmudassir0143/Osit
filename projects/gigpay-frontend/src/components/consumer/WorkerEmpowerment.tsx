  ...
  return (
    <div className="nb-card bg-white rounded-2xl p-6 md:p-8 shadow-brutal-sage">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
        <div>
          <span className="nb-tag bg-sage-light text-sage border-sage/40 text-[9px] mb-2">Why this matters</span>
        ...
        {LIFTS.map((lift, i) => (
          <div key={i} className="border-[1.5px] border-charcoal/10 rounded-xl bg-cream/30 p-4">
            <div className="flex items-start gap-3">
              <div className="font-mono text-[9px] tracking-[0.2em] uppercase text-charcoal/35 shrink-0 mt-0.5">
                {String(i + 1).padStart(2, '0')}
              </div>
              <div className="flex-1">
                <div className="flex items-start gap-2">
                  <span className="font-mono text-[10px] text-terra font-bold mt-0.5 shrink-0">×</span>
                  <span className="text-[12px] text-charcoal/55 leading-snug">{lift.before}</span>
                </div>
                <div className="flex items-start gap-2 mt-1">
                  <span className="font-mono text-[10px] text-sage font-bold mt-0.5 shrink-0">→</span>
                  <span className="text-[12px] text-charcoal/85 font-semibold leading-snug">{lift.after}</span>
                </div>
                <div className="mt-2 inline-block bg-sage-light text-sage border-[1.5px] border-sage/30 px-2 py-0.5 rounded-md text-[10px] font-mono font-semibold">
                  {lift.delta}
                </div>
              </div>
            </div>
      ...
      <div className="mt-5 pt-4 border-t-[1.5px] border-dashed border-charcoal/15 text-[11px] text-charcoal/45 leading-relaxed">
