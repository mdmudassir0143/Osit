  ...
  return (
    <div className="nb-card bg-white rounded-2xl p-6 md:p-8 shadow-brutal-sage">
      <div className="flex items-start justify-between mb-5">
        <div>
          <span className="nb-tag bg-sage-light text-sage border-sage/30 text-[11px] mb-2">Worker Identity</span>
          <h2 className="font-serif text-2xl font-normal text-charcoal tracking-[-0.01em] mt-2">@{profile.handle}</h2>
        </div>
        <div className="w-10 h-10 bg-sage rounded-lg border border-charcoal/15 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-cream rounded-lg p-3 border-[1.5px] border-charcoal/10">
          <div className="text-[11px] tracking-[0.08em] uppercase text-charcoal/40 font-display font-semibold mb-1">Wallet</div>
          <div className="font-mono text-xs text-charcoal break-all">{truncate(address, 8, 6)}</div>
        </div>
        <div className="bg-cream rounded-lg p-3 border-[1.5px] border-charcoal/10">
          <div className="text-[11px] tracking-[0.08em] uppercase text-charcoal/40 font-display font-semibold mb-1">Phone Fingerprint</div>
          <div className="font-mono text-xs text-charcoal/70 break-all">{phoneFingerprint}…</div>
        </div>
        <div className="bg-cream rounded-lg p-3 border-[1.5px] border-charcoal/10">
          <div className="text-[11px] tracking-[0.08em] uppercase text-charcoal/40 font-display font-semibold mb-1">Registered</div>
