  ...
  return (
    <div className="nb-card bg-white rounded-2xl p-6 md:p-8 shadow-brutal-lavender">
      <div className="flex items-start justify-between gap-4 mb-5">
        <div>
          <span className="nb-tag bg-lavender/30 text-charcoal border-lavender/50 text-[9px] mb-2">Share</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-6 items-start">
        {/* QR */}
        <div className="bg-white p-4 border-[2.5px] border-charcoal rounded-xl shadow-brutal-sm w-fit mx-auto md:mx-0">
          <QRCodeSVG value={issuerScanUrl} size={192} bgColor="#fef9ec" fgColor="#22231f" level="M" />
          <div className="mt-3 text-center font-mono text-[10px] tracking-[0.25em] uppercase text-charcoal/45">
            Scan to attest
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div>
            <div className="font-mono text-[9px] tracking-[0.25em] uppercase text-charcoal/40 mb-1.5">Your handle</div>
            <div className="font-display text-2xl font-extrabold text-charcoal">@{handle}</div>
          </div>

          <div>
            <div className="font-mono text-[9px] tracking-[0.25em] uppercase text-charcoal/40 mb-1.5">Public profile</div>
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="nb-btn bg-charcoal text-cream px-3 py-2 text-[10px] font-display font-bold tracking-widest uppercase shrink-0"
              >
              ...
              <a
                ...
                className="nb-btn bg-cream text-charcoal px-3 py-2 text-[10px] font-display font-bold tracking-widest uppercase shrink-0"
              >
                Open ↗
              </a>
            </div>
          ...
          <div>
            <div className="font-mono text-[9px] tracking-[0.25em] uppercase text-charcoal/40 mb-1.5">Wallet address</div>
            <div className="flex items-center gap-2">
              <code className="flex-1 font-mono text-xs text-charcoal/70 bg-cream px-3 py-2 rounded-md border-[1.5px] border-charcoal/10 truncate">
                {address}
              </code>
          ...
          <div className="pt-3 border-t-[1.5px] border-dashed border-charcoal/10 text-[11px] text-charcoal/45 leading-relaxed">
