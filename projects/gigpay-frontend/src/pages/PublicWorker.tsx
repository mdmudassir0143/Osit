      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-10">
        ...
        {error && (
          <div className="nb-card bg-white p-8 shadow-brutal text-center">
            ...
            <Link to="/" className="font-mono text-[12px] tracking-widest uppercase text-terra hover:text-terra-dark">
              Back home
            </Link>
          </div>
        )}
        ...
        {!loading && !error && address && (!profile || !profile.registered) && (
          <div className="nb-card bg-white p-8 shadow-brutal text-center">
            <span className="nb-tag bg-cream text-charcoal/60 border-charcoal/15 text-[11px] mb-3">Not registered</span>
        ...
        {!loading && !error && profile?.registered && address && (
          <div className="space-y-6">
            ...
            <div className="nb-card bg-charcoal text-cream rounded-2xl p-5 md:p-6 shadow-brutal flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <span className="nb-tag bg-cream/10 text-cream/65 border-cream/15 text-[11px] mb-1">Verified · On-chain</span>
                <h1 className="font-serif text-2xl md:text-3xl font-normal tracking-[-0.01em] mt-1">
              ...
              <div className="flex gap-2 shrink-0">
                <Link
                  to="/issuer"
                  className="nb-btn bg-terra text-cream px-4 py-2 text-[12px] font-display font-bold tracking-widest uppercase"
                >
                  Attest →
                </Link>
              </div>
            ...
            <div className="text-center pt-6 text-[12px] font-mono text-charcoal/35">
